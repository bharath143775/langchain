...
def implement_compare_models(prompt):
    ...
    # TODO: Your implementation here
    #pass
    lamma4=implement_llama_4_model()
    lamma3=implement_llama_3_3_model()
    response4=implement_query_model(lamma4,prompt)
    response33=implement_query_model(lamma3,prompt)
    return{
        "lamma4" : response4,
        "lamma3" : response33
    }
